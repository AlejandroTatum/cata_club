 ...
 *
 * `allowedRoles={["estudiante"]}` only: a "representante" account's access to
 * a REPRESENTADO's record is a separate, unrelated screen
 * (feat/ficha-medica-representante, not yet merged as of this branch) — see
 * this route's own file header for the merge note.
 *
...
describe("StudentOwnMedicalRecordPage", () => {
  it("restricts the route to estudiante only", async () => {
    ...
    expect(mockProtectedRoute).toHaveBeenCalledWith(["estudiante"]);
