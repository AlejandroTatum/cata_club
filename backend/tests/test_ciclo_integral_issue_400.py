...
def test_ciclo_integral_inscripcion_a_reactivacion(db_session, monkeypatch):
    ...
    pago1 = pago_servicio.validar_pago(pago1.id, PagoValidarDTO(estado_pago=EstadoPago.APROBADO))
    ...
    pago2 = pago_servicio.validar_pago(pago2.id, PagoValidarDTO(estado_pago=EstadoPago.APROBADO))
    ...
    pago3 = pago_servicio.validar_pago(pago3.id, PagoValidarDTO(estado_pago=EstadoPago.APROBADO))
    ...
    pago4 = pago_servicio.validar_pago(pago4.id, PagoValidarDTO(estado_pago=EstadoPago.APROBADO))
