...
# --- PR4c1 (#1133): la reasignación de representación es ADMINISTRADOR-only ---
# Guardia estructural local (además del guardia global de autorización): la ruta
# del comando presencial existe y declara el rol correcto. Mismo mecanismo que
# `test_no_existe_ruta_de_listado_de_entrenadores`: congelar una propiedad
# estructural revisable en diff.
